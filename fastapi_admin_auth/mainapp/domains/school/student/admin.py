...
# AuthorizedStudentView = AuthorizedModelView(
#     Student,
#     # name="Authorized Student",
#     icon=None,
#     name="Student: Authorized",
# )
# class AuthorizedStudentView(AuthorizedModelView):
...
# StudentView = AuthorizedStudentView(
#     Student,
#     # name="Authorized Student",
#     icon=None,
#     label="AuthorizedStudent",
# )



class CustomActionedStudentView(ModelView):
    exclude_fields_from_list = [Student.description]
    def is_accessible(
        self, request: Request,
...
ActionedStudentView = CustomActionedStudentView(
    Student,
    label="Student: CustomActioned",
)