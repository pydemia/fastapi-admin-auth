...
# AuthorizedTextbookView = AuthorizedModelView(
#     Textbook,
#     # name="Authorized Textbook",
#     icon=None,
#     name="Textbook: Authorized",
# )
# class AuthorizedTextbookView(AuthorizedModelView):
...
# TextbookView = AuthorizedTextbookView(
#     Textbook,
#     # name="Authorized Textbook",
#     icon=None,
#     label="AuthorizedTextbook",
# )



class CustomActionedTextbookView(ModelView):
    exclude_fields_from_list = [Textbook.description]
    def is_accessible(
        self, request: Request,
...
ActionedTextbookView = CustomActionedTextbookView(
    Textbook,
    label="Textbook: CustomActioned",
)