...
# AuthorizedItemView = AuthorizedModelView(
#     Item,
#     # name="Authorized Item",
#     icon=None,
#     name="Item: Authorized",
# )
# class AuthorizedItemView(AuthorizedModelView):
...
# ItemView = AuthorizedItemView(
#     Item,
#     # name="Authorized Item",
#     icon=None,
#     label="AuthorizedItem",
# )



class CustomActionedItemView(ModelView):
    exclude_fields_from_list = [Item.description]
    def is_accessible(
        self, request: Request,
...
# ActionedItemView = CustomActionedItemView(
#     Item,
#     label="Item: CustomActioned",
# )